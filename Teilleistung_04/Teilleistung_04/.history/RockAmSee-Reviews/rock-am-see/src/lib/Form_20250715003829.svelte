...
<form class="card p-4 shadow-custom bg-light" on:submit={handleSubmit}>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control {errors.username ? 'is-invalid' : ''}"
      bind:value={username} maxlength="30" placeholder="Max. 30 Zeichen" />
    {#if errors.username}
  ...
  <div class="mb-3">
    ...
    <select class="form-select {errors.rating ? 'is-invalid' : ''}" bind:value={rating}>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control {errors.title ? 'is-invalid' : ''}"
      bind:value={title} maxlength="30" placeholder="Titel der Erfahrung" />
    {#if errors.title}
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control {errors.review ? 'is-invalid' : ''}"
      bind:value={review} maxlength="250" rows="4" placeholder="Max. 250 Zeichen"></textarea>
    {#if errors.review}
