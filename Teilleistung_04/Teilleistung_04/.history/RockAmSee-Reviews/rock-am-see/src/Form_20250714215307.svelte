<!-- Form.svelte - Eingabeformular mit Bootstrap - Svelte 4 -->
<script>
    import { addReview } from './stores.js';
    
    // Formulardaten (Svelte 4 Syntax)
    let formData = {
        username: '',
        rating: 5,
        title: '',
    ...
    function validateForm() {
        ...
        if (!formData.username.trim()) {
            ...
            errors.username = 'Nutzername darf maximal 30 Zeichen haben';
            isValid = false;
        }
        
        if (formData.rating < 1 || formData.rating > 5) {
            errors.rating = 'Rating muss zwischen 1 und 5 sein';
            isValid = false;
        }
        ...
        if (!formData.report.trim()) {
            errors.report = 'Bericht ist erforderlich';
            isValid = false;
        } else if (formData.report.length > 250) {
            errors.report = 'Bericht darf maximal 250 Zeichen haben';
            isValid = false;
        }
            ...
            {#if showSuccess}
                <div class="alert alert-success alert-dismissible fade show border-0 shadow-sm mb-4" role="alert">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="alert-heading mb-1 fw-bold">🎉 Erfolgreich!</h5>
                            <p class="mb-0">Ihre Bewertung wurde erfolgreich gespeichert!</p>
                        </div>
                    </div>
                </div>
            {/if}
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-primary text-white p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="card-title mb-1 fw-bold">Teilen Sie Ihre Erfahrungen</h3>
                            <p class="card-text mb-0 opacity-75">Ihre Meinung ist uns sehr wichtig</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form on:submit={handleSubmit}>
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                placeholder="Wählen Sie einen aussagekräftigen Titel..."
                                maxlength="30"
                            />
                            {#if errors.title}
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea 
                                ...
                                rows="5"
                                placeholder="Erzählen Sie uns von Ihren Erfahrungen beim Festival..."
                                maxlength="250"
                            ></textarea>
                            {#if errors.report}
                                <div class="invalid-feedback">
